...
import { WebApplicationStructuredData, OrganizationStructuredData, WebSiteStructuredData } from '@/components/structured-data'
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  description: "Create stunning, personalized link-in-bio pages with Curately. Boost your online presence with custom QR codes, deep links, and professional analytics. Perfect for creators, businesses, and influencers.",
  keywords: ["link in bio", "bio link", "link tree", "social media links", "QR codes", "deep links", "creator tools", "influencer tools", "business links"],
